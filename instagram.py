...
class InstagramSpider(scrapy.Spider):
    ...
    def __init__(self, logpass: tuple, **kwargs):
        ...
        self.query_hashs = {'edge_followed_by': 'c76146de99bb02f6415203be841dd25a',
                            'edge_follow': 'd04b0a864b4b54837c0d870b0e77e076',
                            'edge_owner_to_timeline_media': 'd496eb541e5c789274548bf473cc553e'}
    ...
    def parse_followers(self, response, user_vars, user_name, type_q):
        ...
        data = j_response['data']['user'][type_q]['edges']

        for d in data:
            yield {'user_name': user_name, 'user_id': user_vars['id'], 'type_d': type_q, 'data': d['node']}
