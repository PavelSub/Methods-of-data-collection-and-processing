...
class InstagramItem(scrapy.Item):
    ...
    # data_obj = scrapy.Field(output_processor=TakeFirst())


def form_address(val=None):
    if val:
...
class ZillowItem(scrapy.Item):
    ...
    address = scrapy.Field(input_processor=Compose(form_address), output_processor=TakeFirst())  # name and url
